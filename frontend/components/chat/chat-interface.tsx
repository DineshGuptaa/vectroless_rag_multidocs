...
import { Send, StopCircle, FileText, Layers, AlertCircle, Bot } from 'lucide-react'
...
export function ChatInterface({ selectedDocument, onNavigateToDocuments }: ChatInterfaceProps) {
  ...
  useEffect(() => {
    ...
    const handleAnswerStream = (data: any) => {
      ...
      streamedAnswerRef.current += data.chunk
  ...
  const handleSend = async () => {
    ...
    if (selectedDocId && selectedDocId !== 'all') {
      queryBody.document_id = parseInt(selectedDocId)
    }
        ...
        <div className="mx-auto max-w-4xl">
          <div className="flex gap-2">
            <Input
              ...
              placeholder={selectedDocId ? (selectedDocId === 'all' ? "Ask about all documents..." : "Ask about your document...") : "Select a document first..."}
